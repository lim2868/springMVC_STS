package com.office.library.admin.member.mo;
...
public class AdminMemberDao {
	...
	public int insertAdminAccount(AdminMemberVo adminMemberVo) {
		...
		String sql = "INSERT INTO tbl_admin_member(";
			...
			sql+="a_m_id, a_m_pw, a_m_name, a_m_gender, a_m_part, a_m_position, a_m_mail, ";
			sql+="a_m_phone, a_m_reg_date, a_m_mod_date) ";
		...
		//		   sql += "a_m_reg_date, a_m_mod_date) ";
		   ...
		   int result = -1;
		   try { result = jdbcTemplate.update(sql, args.toArray());}

package com.office.library.user.member.mo;
...
public class UserMemberDao {
	...
	public int updateUserAccount(UserMemberVo userMemberVo) {
		...
		String sql = "UPDATE tbl_user_member SET * u_m_name = ?, "
				+ "u_m_gender = ?, "
				+ "u_m_mail = ?, "
				+ "u_m_phone = ?, "
				+ "u_m_mod_date = NOW() "
...
List<UserMemberVo> userMemberVos = new ArrayList<UserMemberVo>();
	...
	public int updatePassword(String u_m_id, String newPassword) {
		...
		String sql = "UPDATE tbl_user_member SET u_m_pw = ? u_m_moddate = NOW() WHERE u_m_id = ?";
